...
public class Question3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("What is the name of prime Minister of BD?");

        jRadioButton1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jRadioButton1.setText("Sheikh Hasina");

        jRadioButton2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jRadioButton2.setText("Sheikh Rehena");

        jRadioButton4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jRadioButton4.setText("Afzal Hossain");

        jRadioButton3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jRadioButton3.setText("Khaleda Zia");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jRadioButton1.isSelected()) {
            CorrectAnswer3 bc = new CorrectAnswer3();
           bc.setVisible(true);
            this.dispose();
        } else {
            this.dispose();
            WrongAnswer3 ab = new WrongAnswer3 ();
            ab.setVisible(true);
        }
